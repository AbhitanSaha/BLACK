...
def make_grayscale(input_image):
	...
	decode_array= cv2.imdecode(image_array, cv2.IMREAD_UNCHANGED)
	print("Decode values of image: ", decode_array)

	converted_img= cv2.cvtColor(decode_array, cv2.COLOR_RGB2GRAY)
